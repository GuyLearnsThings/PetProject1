...
public class NotWorkingCameraMover : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        _inputSystem.CameraMover.Move.performed += OnMoveUp;
        _inputSystem.CameraMover.Move.canceled += OnMoveUp;

        _inputSystem.CameraMover.Move.performed += OnMoveDown;
        _inputSystem.CameraMover.Move.canceled += OnMoveDown;

        _inputSystem.CameraMover.Move.performed += OnLook;
        _inputSystem.CameraMover.Move.canceled += OnLook;

        _inputSystem.CameraMover.Move.performed += OnRightClick;
        _inputSystem.CameraMover.Move.canceled += OnRightClick;
    }
